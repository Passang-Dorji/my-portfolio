    ...
    <div className="bg-transparent/10">
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full h-1/2 overflow-y-auto bg-gradient-to-br from-purple-500 via-indigo-400 to-pink-300 opacity-75 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
